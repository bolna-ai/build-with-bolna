...
![](https://blog.bolna.ai/wp-content/uploads/2025/11/Bolna-feature-image-12-1024x576.jpg)
...
## Table of Contents
- [What is Pre-Call Personalization?](#what-is-pre-call-personalization)
- [Dynamic Script Generation](#dynamic-script-generation)
- [Outbound Call Personalization](#outbound-call-personalization)- [a) Individual Calling (Manual Input)](#a-individual-calling-manual-input)
- [b) Batch Calling (CSV Upload)](#b-batch-calling-csv-upload)
- [c) API Calling (CRM or Database Integration)](#c-api-calling-crm-or-database-integration)

- [Inbound Call Personalization](#4-inbound-call-personalization)- [a) CSV Upload](#a-csv-upload)
- [b) API Connection](#b-api-connection)
- [c) Public Google Sheet](#c-public-google-sheet)

- [Additional Pre-Call Controls](#additional-pre-call-controls)
- [JSON Examples](#6-json-examples)
- [Real Use Case Example ](#real-use-case-example-bolna-compatible)
- [Benefits of Pre-Call Journeys](#benefits-of-pre-call-journeys)
...
![](https://blog.bolna.ai/wp-content/uploads/2025/11/Untitled-diagram-2025-11-19-023701-1024x340.png)Bolna Pre-Call Personalization Flow
...
![](https://blog.bolna.ai/wp-content/uploads/2025/11/ChatGPT-Image-Nov-19-2025-08_03_05-AM-1024x683.png)
...
phone_numbernameplanexpiry_date9876543210RaviGold10 March8765432109PriyaPlatinum18 March
...
phone_numbernameplandue_amount9876543210RaviGold₹1,2998765432109PriyaPlatinum₹2,499
...
**Limit inbound access**You can choose to accept calls only from numbers that exist in your uploaded CSV, Google Sheet, or synced CRM. This reduces unwanted traffic, blocks spam, and ensures your customer data prefill ai calls run on verified information rather than random inputs.

**Max calls per number**Set daily or hourly limits on how many times a single number can reach your system. This helps you avoid accidental loops, misuse, or repeated retries that burn through call credits.

**Bypass list**If you have internal testers, QA teams, or sandbox numbers, you can allow them to skip limits entirely. This makes it easier to test new workflows without affecting real customers or triggering caps meant for production callers.
